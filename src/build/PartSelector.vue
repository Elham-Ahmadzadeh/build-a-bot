<!-- we put props in child component. to be availble for parent component  -->
<template>
...
export default {
  ...
  computed: {
    // we passed selectedPart in $emit
    selectedPart() {
      return this.parts[this.selectedPartIndex]
    }
  },
   // we have to bind it to parent component
   // life cyckle hooks. we  can use UPDATED() as well
  created () {
